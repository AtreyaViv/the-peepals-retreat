  ...
  return (
    <div className="w-[90%] sm:w-[80%] mx-auto my-10 font-sans text-[#2A4630] text-sm sm:text-base leading-relaxed">
      ...
      <ul className="list-none pl-0 space-y-3">
        {[
          "30% token advance at the time of booking, Balance 70% 15 days before the function is required.",
          "Starters will be served for 90 minutes only from the start of the function.",
          "Food and liquor will be served till 23:00 hours only.",
          ...
          "We cater up to 10% above the minimum guaranteed persons. Any increase beyond would be charged additional @ 150 + taxes per person over the agreed minimum number of persons.",
          "Any change in the menu or number of guaranteed persons or number of rooms must be informed 7 days prior to the function in writing.",
          ...
          "Packaged drinking water will be charged @ INR 15/20/50 per person.",
          "All payment must be done only by Cheque/CC/DD. Cash payment will be accepted only with a valid PAN Card & ADHAAR Card. Cheque will be accepted one week before the function.",
