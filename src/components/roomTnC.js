...
const LangToggle = ({ lang, setLang }) => (
  ...
  const termsData = {
    en: [
      ...
      "The standard check-in time is 14:00 Hrs and the standard check-out time is 11:00 Hrs.",
    ...
    hi: [
      ...
      "मानक चेक-इन समय सुबह 14:00 बजे और मानक चेक-आउट समय सुबह 11:00 बजे है।",
